...
// const Login = () => {
//   const { TITLE } = APP_INFO;
//   const [section, setSection] = useState(1); // To track the active section
//   const [textValue, setTextValue] = useState("");
//   const { CreateAccount } = useContext(AuthContext);
//   const [mobile_check, setUsername_check] = useState(false);
//   const [process, setProcess] = useState(false);

//   // Define your form state and refs here
...
//   // const switchSection = (sectionNumber) => {
...
//   //   e.preventDefault();
//   //   if (section === 1) {
//   //     // Section 1 validation and submission logic
//   //   } else {
//   //     // Section 2 validation and submission logic
//   //   }
//   // };
...
//                 {section === 1 && (
//                   <>
//                     {/* Render form fields for section 1 */}
//                     <Row>
//                       <Col md={4}>
//                         <Form.Group controlId="fullName" className="mb-4">
//                           <Form.Label>Full Name</Form.Label>
...
//                 {section === 2 && (
//                   <>
//                     {/* Render form fields for section 2 */}
...
//                   className="group relative w-64 flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-primary-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
//                 >
//                   Next
//                 </Button>
//               )}
